...
class RpcHandler
{
    ...
    inspectUser(params)
    {
        this.tcc_stub.mod.send('C_REQUEST_USER_PAPERDOLL_INFO', 2, {
            name: params.userName
        });
    }
    ...
    initialize(params)
    {
        ...
        this.tcc_stub.mod.log("TCC " + "LFG window " + (this.tcc_stub.useLfg ? "enabled" : "disabled") + ". Ingame LFG listings " + (this.tcc_stub.useLfg ? "will" : "won't") + " be blocked.");
        return true;
    }
}
